...
.EXAMPLE
./RemoveMicrosoftZuneMusic.ps1 
./RemoveMicrosoftZuneMusic.ps1  -debug
./RemoveMicrosoftZuneMusic.ps1  -output <path>
...
Param(
    [String]$Application,
    [Switch]$Debug = $False,
    [String]$Output = "C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\RemoveMicrosoftZuneMusic.log"
)
