<#
**********************************************************************************
Script to remove Mixed Reality Portal applications under user context
**********************************************************************************
...
.DESCRIPTION
This script is use to remove Mixed Reality Portal applications under user context. 
...
.EXAMPLE
./RemoveMicrosoftMixedRealityPortal.ps1 
./RemoveMicrosoftMixedRealityPortal.ps1  -debug
./RemoveMicrosoftMixedRealityPortal.ps1  -output <path>
...
Param(
    [String]$Application,
    [Switch]$Debug = $False,
    [String]$Output = "C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\RemoveMicrosoftMixedRealityPortal.log"
)
...
$Applications = @("Microsoft.MixedReality.Portal")
