<#
**********************************************************************************
Script to remove Microsoft Skype applications under user context
**********************************************************************************
...
.DESCRIPTION
This script is use to remove Microsoft Skype applications under user context. 
...
.EXAMPLE
./RemoveMicrosoftSkype.ps1 
./RemoveMicrosoftSkype.ps1  -debug
./RemoveMicrosoftSkype.ps1  -output <path>
...
Param(
    [String]$Application,
    [Switch]$Debug = $False,
    [String]$Output = "C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\RemoveMicrosoftSkype.log"
)
...
$Applications = @("Microsoft.SkypeApp")
