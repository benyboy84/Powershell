<#
**********************************************************************************
Script to remove Movies & TV applications under user context
**********************************************************************************
...
.DESCRIPTION
This script is use to remove Movies & TV applications under user context. 
...
.EXAMPLE
./RemoveMicrosoftZuneVideo.ps1 
./RemoveMicrosoftZuneVideo.ps1  -debug
./RemoveMicrosoftZuneVideo.ps1  -output <path>
...
Param(
    [String]$Application,
    [Switch]$Debug = $False,
    [String]$Output = "C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\RemoveMicrosoftZuneVideo.log"
)
...
$Applications = @("Microsoft.ZuneVideo")
