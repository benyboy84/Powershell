<#
**********************************************************************************
Script to detect if Xbox applications are removed.
**********************************************************************************

.SYNOPSIS
Script to detect if Xbox applications like are removed

Version 1.0 of this script.

.DESCRIPTION
This script is use to detect if Xbox applications are removed

.EXAMPLE
./RemoveXboxApps-Detection.ps1 
